...
const statusLabels = { active: 'Activa', inactive: 'Inactiva', past_due: 'Pendiente de pago', canceled: 'Cancelada' };
...
const AccountPage = () => {
  ...
  return (
    <>
      <Helmet><title>Mi cuenta - MAROT STRATEGIES</title></Helmet>
              ...
              {subActive ? (
                <div>
                  ...
                  <p className="text-zinc-400 text-sm mt-1">
                    Estado: <span className="text-emerald-400">{statusLabels[profile.subscription_status]}</span>
                  </p>
                  <p className="text-zinc-500 text-sm">
                    Expira: {new Date(profile.subscription_expires_at).toLocaleDateString('es-ES')}
                  </p>
                </div>
              ) : (
                <div>
                  <p className="text-zinc-400 mb-3">No tienes una suscripción activa.</p>
